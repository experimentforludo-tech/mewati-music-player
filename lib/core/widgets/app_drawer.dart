      ...
      child: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _SectionTitle(label: 'MUSIC', color: t.textSecondary),
            ...
            _SectionTitle(label: 'THEME SETTINGS', color: t.textSecondary),
            const SizedBox(height: 10),
            ...
            const SizedBox(height: 18),
            _SectionTitle(label: 'EQUALIZER', color: t.textSecondary),
            const SizedBox(height: 10),
            ...
            const SizedBox(height: 18),
            _SectionTitle(label: 'ADDITIONAL FEATURES', color: t.textSecondary),
            const SizedBox(height: 10),
            _DrawerActionRow(
